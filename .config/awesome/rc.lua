...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "space", function () awful.layout.inc( 1)                end,
        {description = "select next layout", group = "layout"}), --[[ conflict with keyboard layout switching ]]
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "Up", function (c)
        ...
        {description = "Floating Resize Vertical -", group = "client.floating.resize"}),
    ...
    awful.key({ modkey, "Control" }, "Left", function (c)
        ...
        {description = "Floating Resize Horizontal -", group = "client.floating.resize"}),
    ...
    awful.key({ modkey, "Shift"   }, "Down", function (c)
        ...
        {description = "Floating Move Down", group = "client.floating.move"}),
    awful.key({ modkey, "Shift"   }, "Up", function (c)
        c:relative_move(  0, -10,   0,   0) end,
        {description = "Floating Move Up", group = "client.floating.move"}),
    awful.key({ modkey, "Shift"   }, "Left", function (c)
        c:relative_move(-10,   0,   0,   0) end,
        {description = "Floating Move Left", group = "client.floating.move"}),
    awful.key({ modkey, "Shift"   }, "Right", function (c)
        c:relative_move( 10,   0,   0,   0) end,
        {description = "Floating Move Right", group = "client.floating.move"}),
    ...
    awful.key({ modkey,           }, "j", function (c)
        ...
        {description = "focus next window up", group = "client.focus"}),
    awful.key({ modkey,           }, "k", function (c)
        awful.client.focus.global_bydirection("up")
        c:lower()
    end,
        {description = "focus next window down", group = "client.focus"}),
    awful.key({ modkey,           }, "l", function (c)
        awful.client.focus.global_bydirection("right")
        c:lower()
    end,
        {description = "focus next window right", group = "client.focus"}),
    awful.key({ modkey,           }, "h", function (c)
        awful.client.focus.global_bydirection("left")
        c:lower()
    end,
        {description = "focus next window left", group = "client.focus"}),
